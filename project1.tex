...
\hyperdef{}{sample-mean-versus-theoretical-mean}{\subsection{Sample Mean
...
\includegraphics{figure/samplemean-1.pdf}
...
(\(1/\lambda^2\)). \includegraphics{figure/samplevar-1.pdf}
...
\hyperdef{}{distribution-is-approximately-normal}{\subsection{Distribution
