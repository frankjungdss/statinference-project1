...
Make \texttt{40} observations of the exponential distribution repeating
this \texttt{1000} times. Then take the mean for each sample of
...
repeating this \texttt{1000} times. The take the variance for each
