...
Make ```r observ``` observations of the exponential distribution repeating this
```r samples``` times. Then take the mean for each sample of observations. The mean
...
repeating this ```r samples``` times. The take the variance for each sample of 
