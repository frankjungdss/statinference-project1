...
# TeX document manual adjustments:
# \documentclass[legalpaper,11pt]{article}
# \includegraphics[origin=c]{figure/samplenormals-1.pdf}
```
...
distribution of these averages tends to that of a standard normal as the sample size
increases.
