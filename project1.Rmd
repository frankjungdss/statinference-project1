...
increases. Plotting the histogram we should see a normal like distribution:
...
We can test this analyticallt using the [Quantile-Quantile
...
normal (red line).
```{r qqnorm, echo=FALSE, message=FALSE, warning=FALSE}
